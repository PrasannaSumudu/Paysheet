...
public class viewallpays extends JFrame{
...
JPanel p4,jp6;
JComboBox religojb,gradjb,cbe,cbe1;     
...
//        setin1.setIcon(new ImageIcon(getClass().getResource("images/settingg.png")));
 ...
 JLabel  setin = new JLabel("123456");
 ...
 //add(setin); 
  ...
  JLabel mon = new JLabel("Month");
         mon.setBounds(420,95,80,20); 
         mon.setForeground(Color.WHITE);
         add(mon);  
         
cbe = new JComboBox();
cbe.setBounds(480,95,80,20);
cbe.addItem("January");
...
add(cbe);
         ...
         ye.setBounds(580,95,80,20); 
         ye.setForeground(Color.WHITE);
         add(ye);  
         
cbe1 = new JComboBox();
cbe1.setBounds(620,95,50,20);
cbe1.addItem("2017");
cbe1.addItem("2018");
cbe1.addItem("2019");
cbe1.addItem("2020");
...
//        min.setIcon(new ImageIcon(getClass().getResource("images/ben/minimise.png")));
 ...
 set.setFont(ca44);
  ...
  jScrollPane1.setVerticalScrollBarPolicy(
   ...
   headers.add("mont");
   headers.add("year");
   headers.add("deduction");
   headers.add("bank");
   headers.add("name");
   headers.add("ac_no");
     headers.add("amou");
     headers.add("page");
     headers.add("total_pay");
     headers.add("lo_ac");
...
table.getColumn("p_no").setMaxWidth(40);
table.getColumn("amount").setMaxWidth(80);
table.getColumn("mont").setMaxWidth(50);
table.getColumn("year").setMaxWidth(40);
table.getColumn("deduction").setMaxWidth(70);
table.getColumn("bank").setMaxWidth(50);
table.getColumn("name").setMaxWidth(200);
table.getColumn("ac_no").setMaxWidth(110);
table.getColumn("amou").setMaxWidth(60);
table.getColumn("page").setMaxWidth(50);
table.getColumn("total_pay").setMaxWidth(60);
table.getColumn("lo_ac").setMaxWidth(90);
...
jpl.add( scrollPane );
  // scrollPane.getViewport().setBackground(new Color(1,1,100,0));    
   ...
   // jPanel1.setBackground(Color.red);
       ...
       JLabel adn3 = new JLabel("Find teacher from any details");
...
//-------------------------------------------------------------
  ...
  String str="select * from pay_details";
  Connection cn;
  ResultSet rs;
  Statement st;
  ...
  try {
   ...
   while(rs.next())
   {
    ...
    d.add(rs.getString("mont"));
    d.add(rs.getString("year"));
   d.add(rs.getString("deduction"));      
     d.add(rs.getString("bank"));
      d.add(rs.getString("nam"));
       d.add(rs.getString("ac_no"));
    d.add(rs.getString("amou"));
     d.add(rs.getString("page"));
       d.add(rs.getString("total_pay"));
     d.add(rs.getString("lo_ac"));
 ...
 jTextField1.addKeyListener(new KeyAdapter() {
	...
	adn.setBounds(760,100,200,20);
        adn.setForeground(Color.WHITE);
	add(adn);
        
    int rows = table.getRowCount();
    //int cols = table.getColumnCount();
    
   adn.setText("Total Teachers - "+ String.valueOf(rows));
