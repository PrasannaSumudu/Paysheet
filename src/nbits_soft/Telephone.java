...
//        min.setIcon(new ImageIcon(getClass().getResource("images/ben/minimise.png")));
 ...
 p_ids = new JTextField();
p_ids.setBounds(490,130,100,20);
add(p_ids); 
  ...
  JLabel set = new JLabel("Contact No.");
 ...
 set.setFont(ca44);
    ...
    jScrollPane1.setBounds(10,50,370,350);
...
table.getColumn("name").setMaxWidth(210);
table.getColumn("te_infor").setMaxWidth(110);
...
jpl.add( scrollPane );
  // scrollPane.getViewport().setBackground(new Color(1,1,100,0));    
   ...
   // jPanel1.setBackground(Color.red);
       ...
       JLabel adn3 = new JLabel("Search Information");
...
//    String str1="select b_name from banks WHERE b_id ="+rs.getString("bank");
